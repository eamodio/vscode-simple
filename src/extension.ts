import type { CancellationToken, Disposable, ExtensionContext, Progress, WebviewPanel } from 'vscode';
import { commands, ProgressLocation, ViewColumn, window } from 'vscode';

export function activate(context: ExtensionContext) {
	context.subscriptions.push(
		window.registerWebviewPanelSerializer('simple.sample', {
...
function loadWebview(panel: WebviewPanel) {
